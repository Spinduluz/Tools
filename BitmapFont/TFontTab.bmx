Function NewFontDialog:Int( fontpath:String Var,fsize:Int Var,texwidth:Int Var,texheight:Int Var )
	...
	Local dialog:TGadget=CreateWindow( "New font",0,0,320,234,_window,WINDOW_CENTER|WINDOW_TITLEBAR|WINDOW_CLIENTCOORDS )
	...
	Local ranges:TGadget=CreateListBox( 190,60,120,164,dialog )
	Local buttonOk:TGadget=CreateButton( "&Ok",10,200,80,24,dialog )
	Local buttonCancel:TGadget=CreateButton( "&Cancel",100,200,80,24,dialog ) 
	...
	Local rangesLabel:TGadget=CreateLabel( "Character ranges",190,40,120,24,dialog,LABEL_CENTER )
	
	CreateLabel "",10,105,175,5,dialog,LABEL_SEPARATOR
